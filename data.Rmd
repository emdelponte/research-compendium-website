...
The data were obtained from xx and were organized in xx excel/csv files. The file is in the wide format where each day of assessment is in a different column, etc.
