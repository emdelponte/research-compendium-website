...
A Pesquisa Reproduzível (PR) tem a característica de reprodutibilidade, ou seja, a habilidade de um pesquisador em obter os resultados de um estudo prévio usando os mesmos materiais (dados) e métodos (estatística) da pesquisa original. Portanto, a condição *sine qua non* para que isso seja possível é que o pesquisador independente tenha a) acesso aos dados e b) saiba detalhes de como a análise foi feita. 
